...
tx = {
  ...
  vin: [
    {
      ...
      prevout: {
        ...
        scriptpubkey_asm:
          "OP_0 OP_PUSHBYTES_20 b2d46ba014a6ceeb9f52c4bd309b521400722014",
...

    {
      ...
      prevout: {
        ...
        scriptpubkey_asm:
          "OP_0 OP_PUSHBYTES_20 ce91edd1f5e310b9027bd06aaf24477516406b62",
...

    {
      ...
      prevout: {
        ...
        scriptpubkey_asm:
          "OP_HASH160 OP_PUSHBYTES_20 572916855e4175478289d70c2b0c1e7eccef5001 OP_EQUAL",
      ...
      scriptsig_asm:
        "OP_PUSHBYTES_22 0014e45f69ef326f32752f59335c53a77b70485b340c",
      ...
      inner_redeemscript_asm:
        "OP_0 OP_PUSHBYTES_20 e45f69ef326f32752f59335c53a77b70485b340c",
    },
  ],
  ...
  vout: [
...

    {
      ...
      scriptpubkey_asm:
        "OP_RETURN OP_PUSHBYTES_1 52 OP_PUSHBYTES_10 0080c7b5e38a23866802",
    ...
    {
      scriptpubkey:
        "512015f5cab2f9e2c9e634a53223314ca0305fb9f1126fc74ab73b0d534708331837",

      scriptpubkey_asm:
        "OP_PUSHNUM_1 OP_PUSHBYTES_32 15f5cab2f9e2c9e634a53223314ca0305fb9f1126fc74ab73b0d534708331837",

      scriptpubkey_type: "v1_p2tr",

      scriptpubkey_address:
        "bc1pzh6u4vheuty7vd99xg3nzn9qxp0mnugjdlr54demp4f5wzpnrqms6vawdq",
...

    {
      ...
      scriptpubkey_asm:
        "OP_0 OP_PUSHBYTES_20 56842e8539efe5d08cf67e536fdeb89f6fc9c00b",
